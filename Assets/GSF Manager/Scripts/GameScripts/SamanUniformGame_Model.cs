...
[System.Serializable]
public class SamanUniformGame_Model_UI
{
    ...
    public GameObject InstrumentScroller,NecklaceScroller, HairScroller,  EarringScroller, ShoesScroller, AllScrollers;
    [Header("PLayer Items")]
    public Image PlayerDress;
    public Image PlayerInstrument, PlayerNecklace, PlayerHair,PlayerEarrings, PlayerShoes;
    public Image playerAvatar_1, playerAvatar_2;
    [Header("Opponent Items")]
    public Image OpponentDress;
    public Image OpponentInstrument,OpponentNecklace, OpponentHair, OpponentEarrings, OpponentShoes;
...
public class SamanUniformGame_Model : MonoBehaviour
{
    #region Variables
    [System.Serializable]
    public enum SelectedItem
    {
        None, Dress,Shoes, Hair,Earrings, Necklace,  Instrument

    }
    [FoldoutGroup("IQRA INDIAN SGAME INDIAN WEDDING UI")]
    [HideLabel]
    public SamanUniformGame_Model_UI uIElements;
    ...
    private List<ItemInfo> InstrumentList = new List<ItemInfo>();
    ...
    private int dressRank, hairsRank, ShoesRank;
    private int necklaceRank, earringsRank;
    private int InstrumentRank;
    ...
    private void Start()
    {
        ...
        InstrumentRank = dressRank = hairsRank = ShoesRank = earringsRank = 1;
    ...
    IEnumerator SamanUniformGame_InitializeValues()
    {
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode1Items.DressLock, dressList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode1Items.HairLock, hairList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode1Items.NecklaceLock, necklaceList);
        ...
        {
            var earingInfo = uIElements.EarringScroller.GetComponentsInChildren<ItemInfo>();
            for (int i = 0; i < earingInfo.Length; i++)
            {
                earringsList.Add(earingInfo[i]);
            }
        }
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode1Items.EarringsLock, earringsList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode1Items.ShoesLock, ShoesList);
        SamanUniformGame_SetItemIcon(ShoesList, ShoesSprites);
        #endregion


        yield return new WaitForSeconds(0.2f);

        #region Initializing Instrument
        if (uIElements.InstrumentScroller)
        {
            var InstrumentInfo = uIElements.InstrumentScroller.GetComponentsInChildren<ItemInfo>();
            for (int i = 0; i < InstrumentInfo.Length; i++)
            {
                InstrumentList.Add(InstrumentInfo[i]);
            }
        }
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode1Items.InstrumentLock, InstrumentList);
        SamanUniformGame_SetItemIcon(InstrumentList, InstrumentSprites);
        #endregion
    ...
    private void SamanUniformGame_GetItemsInfo()
    {
        ...
        else if (selectedItem == SelectedItem.Instrument)
        {
            SamanUniformGame_SetItemsInfo(InstrumentList);
        }
        ...
        else if (selectedItem == SelectedItem.Shoes)
        {
            SamanUniformGame_SetItemsInfo(ShoesList);
        }
    ...
    public void SamanUniformGame_SelectItem(int index)
    {
        ...
        {
            SamanUniformGame_CheckSelectedItem(InstrumentList, InstrumentSprites, uIElements.PlayerInstrument);
        }
        ...
        {
            SamanUniformGame_CheckSelectedItem(ShoesList, ShoesSprites, uIElements.PlayerShoes);
        }
                ...
                if (itemSprites.Length > selectedIndex)
                {
                    if (itemSprites[selectedIndex])
                    {
                        if (itemImage)
                        {
                            ...
                            if (selectedItem == SelectedItem.Shoes)
                                ShoesRank = 1;
                            else if (selectedItem == SelectedItem.Necklace)
                                necklaceRank = 1;
                            else if (selectedItem == SelectedItem.Earrings)
    ...
    public void SamanUniformGame_UnlockSingleItem()
    {
        if (selectedItem == SelectedItem.Hair)
        {
            SaveData.Instance.Mode1Items.HairLock[selectedIndex] = false;
        }
      
        else if (selectedItem == SelectedItem.Instrument)
        {
            SaveData.Instance.Mode1Items.InstrumentLock[selectedIndex] = false;
        }
      
        else if (selectedItem == SelectedItem.Earrings)
        {
            SaveData.Instance.Mode1Items.EarringsLock[selectedIndex] = false;
        }
      
        else if (selectedItem == SelectedItem.Dress)
        {
            SaveData.Instance.Mode1Items.DressLock[selectedIndex] = false;
        }
        else if (selectedItem == SelectedItem.Necklace)
        {
            SaveData.Instance.Mode1Items.NecklaceLock[selectedIndex] = false;
        }
        else if (selectedItem == SelectedItem.Shoes)
        {
            SaveData.Instance.Mode1Items.ShoesLock[selectedIndex] = false;
        }
        //change section
    ...
    public void SamanUniformGame_SelectCategory(int index)
    {
        ...
        if (index == 0)
        {
            ...
            selectedItem = SelectedItem.Dress;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-100f, -50f, 200f), 1);
        }
        ...
        else if (index == 1)
        {
            ...
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-50f, -300f, -150f), 1);
        }
        ...
        else if (index == 2)
        {
            ...
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(0f, -400f, -400f), 1);
        }
        else if (index == 3)
        {
            uIElements.EarringScroller.SetActive(true);
            selectedItem = SelectedItem.Earrings;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(0f, -600f, -500f), 1);
        }
       
        else if (index == 4)
        {
            uIElements.InstrumentScroller.SetActive(true);
            selectedItem = SelectedItem.Instrument;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(- 62f, 0f, 150f), 1);
        }
        else if (index == 5)
        {
            uIElements.ShoesScroller.SetActive(true);
            selectedItem = SelectedItem.Shoes;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-10f, -50f, 100f), 1);
        }
    ...
    public void SamanUniformGame_DisableScroller()
    {
        ...
        uIElements.InstrumentScroller.SetActive(false);
    ...
    public void SamanUniformGame_Preview()
    {
        if (readyCount >= 10)
        {
            ...
            uIElements.previewPanel.SetActive(true);
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-50f, -50f, 400f), 1);
        }
        else
        {
    ...
    public void SamanUniformGame_Submit()
    {
        uIElements.coinSlot.SetActive(false);
        uIElements.videoSlot.SetActive(false);
        uIElements.AllScrollers.SetActive(false); uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-200f, -50f, 400f), 0.5f).OnComplete(delegate
        {
    ...
    IEnumerator SamanUniformGame_Judgement()
    {
        ...
        uIElements.OpponentCharacter.transform.DOLocalMove(new Vector3(530f, -50f, 400f), 0.5f);
        yield return new WaitForSeconds(0.5f);
        uIElements.judgesPanel.transform.parent.gameObject.SetActive(true);
        uIElements.judgesPanel.transform.localPosition += Vector3.down * 500;
        uIElements.judgesPanel.transform.DOLocalMove(new Vector3(-0f, -850f, 100f), 0.5f);
        yield return new WaitForSeconds(2f);
        uIElements.playerPoints.text = ((((dressRank + ShoesRank) * 100) / 15)).ToString();
        uIElements.opponentPoints.text = OP_DressingPoints.ToString();
        StartCoroutine(SamanUniformGame_AddPlayerScore((((dressRank + ShoesRank) * 100) / 20)));
        StartCoroutine(SamanUniformGame_AddOpponentScore(OP_DressingPoints));
        ManageStars((((dressRank + ShoesRank) * 100) / 30), OP_DressingPoints);
        yield return new WaitForSeconds(2.5f);
        uIElements.playerPoints.text = ((((InstrumentRank + hairsRank + necklaceRank) * 100) / 30)).ToString();
        uIElements.opponentPoints.text = OP_MakeupPoints.ToString();
        StartCoroutine(SamanUniformGame_AddPlayerScore((((hairsRank + earringsRank) * 100) / 20)));
        StartCoroutine(SamanUniformGame_AddOpponentScore(OP_MakeupPoints));
        ManageStars((((dressRank + hairsRank + earringsRank) * 100) / 30), OP_MakeupPoints);
        yield return new WaitForSeconds(2.5f);
        ...
        StartCoroutine(SamanUniformGame_AddPlayerScore((((necklaceRank + earringsRank + hairsRank) * 100) / 20)));
        StartCoroutine(SamanUniformGame_AddOpponentScore(OP_JewellertPoints));
        ManageStars((((necklaceRank + earringsRank + hairsRank) * 100) / 40), OP_JewellertPoints);
        yield return new WaitForSeconds(2f);
        uIElements.judgesPanel.transform.parent.gameObject.SetActive(false);
        if (playerScore >= opponentScore)
        {
     
            uIElements.PlayerCharacter.transform.parent = uIElements.characterParent.transform;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(0f, -250f, 100f), 0.5f);
        ...
        else
        {
            ...
            uIElements.OpponentCharacter.transform.DOLocalMove(new Vector3(0f, -250f, 100f), 0.5f);
    ...
    private void SamanUniformGame_DressupOpponent()
    {
        ...
        OP_DressingPoints++;
        // WearItem(uIElements.OpponentShoes, ShoesSprites);
        OP_DressingPoints = ((OP_DressingPoints * 100) / 30);
        ...
        {
            OP_MakeupPoints++;
            WearItem(uIElements.OpponentDress, DressSprites);
        }
        OP_MakeupPoints++;
        WearItem(uIElements.OpponentHair, HairSprites);
        OP_MakeupPoints++;
        WearItem(uIElements.OpponentInstrument, InstrumentSprites);
        OP_MakeupPoints = ((OP_MakeupPoints * 100) / 40);
        ...
        OP_JewellertPoints = ((OP_JewellertPoints * 100) / 50);
    }
    ...
    public void SamanUniformGame_UnlockAllItems()
    {
        ...
        SamanUniformGame_UnlockList(ShoesList);
        SamanUniformGame_UnlockList(InstrumentList);
