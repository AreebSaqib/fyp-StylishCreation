...
[System.Serializable]
public class SamanUniformGame_Mode4_UI
{
    ...
    public GameObject ShoesScroller,NecklaceScroller, HairScroller, EarringScroller, BagScroller, AllScrollers;
    [Header("PLayer Items")]
    public Image PlayerShoes;
    public Image PlayerDress, PlayerNecklace, PlayerHair, PlayerEarrings, PlayerBag;
    public Image playerAvatar_1, playerAvatar_2;
    [Header("Opponent Items")]
    public Image OpponentShoes;
    public Image OpponentDress, OpponentNecklace, OpponentHair, OpponentEarrings, OpponentBag;
...
#endregion
public class SamanUniformGame_Mode4 : MonoBehaviour
{
    #region Variables
    [System.Serializable]
    public enum SelectedItem
    {
        None, Dress, Bag, Hair, Shoes, Earrings, Necklace
    }
    [FoldoutGroup("Saman Uniform Game Mode4 UI")]
    [HideLabel]
    public SamanUniformGame_Mode4_UI uIElements;
    ...
    private int ShoesRank, lipsRank;
    private int necklaceRank, earringsRank,blushRank;
    ...
    private void Start()
    {
        ...
        ShoesRank = dressRank = hairsRank =earringsRank= 1;
    ...
    IEnumerator SamanUniformGame_InitializeValues()
    {
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode4Items.DressLock, dressList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode4Items.HairLock, hairList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode4Items.NecklaceLock, necklaceList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode4Items.EarringsLock, earringsList);
        ...
        #region Initializing Shoess
        if (uIElements.ShoesScroller)
        {
            var ShoessInfo = uIElements.ShoesScroller.GetComponentsInChildren<ItemInfo>();
            for (int i = 0; i < ShoessInfo.Length; i++)
            {
                ShoesList.Add(ShoessInfo[i]);
            }
        }
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode4Items.ShoesLock, ShoesList);
        ...
        SamanUniformGame_SetupItemData(SaveData.Instance.Mode4Items.BagLock, BagList);
    ...
    public void SamanUniformGame_UnlockSingleItem()
    {
        if (selectedItem == SelectedItem.Hair)
        {
            SaveData.Instance.Mode4Items.HairLock[selectedIndex] = false;
        }
        ...
        {
            SaveData.Instance.Mode4Items.ShoesLock[selectedIndex] = false;
        }

        else if (selectedItem == SelectedItem.Earrings)
        {
            SaveData.Instance.Mode4Items.EarringsLock[selectedIndex] = false;
        }
        
        else if (selectedItem == SelectedItem.Dress)
        {
            SaveData.Instance.Mode4Items.DressLock[selectedIndex] = false;
        }
        else if (selectedItem == SelectedItem.Necklace)
        {
            SaveData.Instance.Mode4Items.NecklaceLock[selectedIndex] = false;
        }
        else if (selectedItem == SelectedItem.Bag)
        {
            SaveData.Instance.Mode4Items.BagLock[selectedIndex] = false;
        }
        SamanGame_SaveLoad.SaveProgress();
    }
    #endregion
    ...
    public void SamanUniformGame_SelectCategory(int index)
    {
        ...
        if (index == 0)
        {
            ...
            selectedItem = SelectedItem.Dress;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-200f, -240f, 400f), 1);
        }
        ...
        else if (index == 1)
        {
            ...
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-200f, -500f, 0f), 1);
        }
        else if (index == 2)
        {
            uIElements.NecklaceScroller.SetActive(true);
            selectedItem = SelectedItem.Necklace;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-100f, -400f, -350f), 1);
        }
        else if (index == 3)
        {
            uIElements.ShoesScroller.SetActive(true);
            selectedItem = SelectedItem.Shoes;
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-150f, -100f, 300f), 1);
        }
        ...
        else if (index == 4)
        {
            ...
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-110f, -300f, -50f), 1);
        }
        ...
        else if (index == 5)
        {
            ...
            uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-206f,-150f, 400f), 1);
        }
    ...
    public void SamanUniformGame_Submit()
    {
        uIElements.coinSlot.SetActive(false);
        uIElements.videoSlot.SetActive(false);
        uIElements.AllScrollers.SetActive(false); uIElements.PlayerCharacter.transform.DOLocalMove(new Vector3(-300f, -50f, 500f), 0.5f).OnComplete(delegate
        {
    ...
    IEnumerator SamanUniformGame_Judgement()
    {
        ...
        uIElements.OpponentCharacter.transform.DOLocalMove(new Vector3(400f, -50f, 500f), 0.5f);
        yield return new WaitForSeconds(0.5f);
        ...
        yield return new WaitForSeconds(2f);
        uIElements.playerPoints.text = ((((dressRank + BagRank + blushRank) * 100) / 30)).ToString();
        uIElements.opponentPoints.text = OP_DressingPoints.ToString();
        StartCoroutine(SamanUniformGame_AddPlayerScore((((dressRank + BagRank + blushRank) * 100) / 30)));
        StartCoroutine(SamanUniformGame_AddOpponentScore(OP_DressingPoints));
        ManageStars((((dressRank + BagRank +blushRank) * 100) / 30), OP_DressingPoints);
        yield return new WaitForSeconds(2.5f);
        uIElements.playerPoints.text = ((((lipsRank + hairsRank + ShoesRank) * 100) / 30)).ToString();
        uIElements.opponentPoints.text = OP_MakeupPoints.ToString();
        StartCoroutine(SamanUniformGame_AddPlayerScore((((hairsRank + ShoesRank) * 100) / 30)));
        StartCoroutine(SamanUniformGame_AddOpponentScore(OP_MakeupPoints));
        ManageStars((((lipsRank + hairsRank + ShoesRank) * 100) / 30), OP_MakeupPoints);
        yield return new WaitForSeconds(2.5f);
        uIElements.playerPoints.text = ((((necklaceRank + earringsRank ) * 100) / 20)).ToString();
        uIElements.opponentPoints.text = OP_JewellertPoints.ToString();
        StartCoroutine(SamanUniformGame_AddPlayerScore((((necklaceRank + earringsRank) * 100) / 20)));
        StartCoroutine(SamanUniformGame_AddOpponentScore(OP_JewellertPoints));
        ManageStars((((necklaceRank + earringsRank) * 100) / 20), OP_JewellertPoints);
        yield return new WaitForSeconds(2f);
    ...
    public void SamanUniformGame_UnlockAllItems()
    {
        ...
        SamanUniformGame_UnlockList(lipsList);
